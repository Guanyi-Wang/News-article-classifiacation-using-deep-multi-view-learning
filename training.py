...
tf.flags.DEFINE_integer('num_training', 74000, "Number of training samples")

# Model parameters
tf.flags.DEFINE_integer('word_embedding_dimension', 300, "Dimension of word embeddings(default: 300)")
tf.flags.DEFINE_string('filter_sizes', "2,4,8", "Filter size(default: 3,4,5)")
tf.flags.DEFINE_integer('num_filters', 64, "Number of filters per filter size(default: 128)")
tf.flags.DEFINE_float('dropout_keep_prob', 0.5, "Dropout keep probability(default: 0.5)")
tf.flags.DEFINE_integer("num_hidden", 128, "Number of neurons in hidden layers ")
tf.flags.DEFINE_integer("regular_const", 0.01, "Regularization constant")
tf.flags.DEFINE_integer('chunk_size', 2, "chunk size when doing dynamic pooling")
...
# Load data
print("Loading data ...")
[data_x, data_y, ids] = load_data_new('Data/DM_HEADLINE.txt', 'Data/DM_CATEGORY.txt')
